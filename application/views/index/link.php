        ...
        <div id="blog">
            ...
            <h3>
                ...
                <div>
                    ...
                    站点名称：   <input type="text" id="sitetitle" placeholder="例：不知西东博客" class="comment_input">
                    站点URL：  <input type="text" id="siteurl" placeholder="例：www.yafblog.com" class="comment_input">
